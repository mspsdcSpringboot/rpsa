...
//
    $.ajax({
        type: "GET",
        url: "./getpendingwithtaskwise.htm",
        data: "serviceid=" + $("#serviceid").val()+"&owid="+ $("#owid").val(),
        beforeSend: function (xhr)
        {
            xhr.setRequestHeader(csrfHeader, csrfToken);
        },
...
$(document).ready(function () {
    ...
    $.ajax({
        type: "GET",
        url: "./gettaskwiselabourjson.htm",
        data: "serviceid=" + $("#serviceid").val() + "&locationid=" + $("#owid").val(),
        beforeSend: function (xhr)
        {
            xhr.setRequestHeader(csrfHeader, csrfToken);
        },
        success: function (data) {
            ...
            const dataSource = {
                chart: {
                    caption: "Taskwise Pendency List",
                    subcaption: "",
                   xaxisname: "Name of Tasks",
